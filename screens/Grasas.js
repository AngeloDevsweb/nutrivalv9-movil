...
const Grasas = () => {
    ...
    useEffect(() => {
        const getLista = async()=>{
            try {
                const querySnapshot = await getDocs(collection(db, 'grasas'))
                const docs = []
    ...
    return (
        ...
        <View style={styles.padre}>
          ...
          >
            <Text style={styles.textoImagen}>GRASAS</Text>
          </ImageBackground>
        </View>
        {/* fin del encabezado */}
        <Text style={styles.title}>Por 100gr. de alimento se obtiene un (N°) de grasa en gramos</Text>
